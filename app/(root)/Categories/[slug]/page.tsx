...
import { allProducts, allGuides } from "@/lib/utils";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {filteredPosts.map((post) => (
                <Link
                  ...
                  className="block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 ease-out"
                >
                  ...
                  <div className="p-4 sm:p-5">
                    ...
                    <div className="inline-flex items-center text-indigo-600 font-medium group">
                      Read More
                ...
                >
                  ...
                  <div className="p-4 sm:p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-sm bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors">
                        Add to Cart
                      </div>
                    </div>
                  </div>
