      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {posts.map((post, index) => (
            ...
            >
              <Card
                className={`overflow-hidden bg-white border-none shadow-md transition-shadow duration-300 rounded-2xl ${
              ...
              >
                ...
                <div className="relative">
                  ...
                  <motion.span
                    className={`absolute top-4 left-4 text-[11px] md:text-xs font-semibold px-3 py-1 rounded-full shadow-sm ${
                      categoryColors[post.category] || "bg-neutral-200 text-neutral-600"
                    }`}
                ...
                <CardFooter className="px-4 md:px-6 pb-4">
                  ...
                  >
                    ...
                    >
                      <Link href={`/blog/${post.slug.current}`} className="inline-block">
                        Read More
                      </Link>
                      <motion.div
                        animate={{
